...
pkgname=matsya-screenshot
pkgver=1
pkgrel=1
pkgdesc="matsya screenshot of Matsya Ui."
arch=('x86_64')
url="https://github.com/MatsyaOs/screenshot"
license=('GPL')
groups=('Matsya')
makedepends=('git')
depends=(
...
source=('git'+'https://github.com/MatsyaOs/screenshot')
md5sums=('SKIP')
